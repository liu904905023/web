...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->Setsub_mch_id(cookie('sub_mch_id'));
		$inputObj->SetAppid(cookie('appid'));//公众账号ID
		$inputObj->SetMch_id(cookie('mchid'));//商户号
...
class JsApiPay extends WxPayApi
{
	...
	{
		$urlObj["appid"] = cookie('appid');
		$urlObj["secret"] = cookie('appsecret');
		$urlObj["code"] = $code;
